shared_examples_for 'all stores' do
  describe "#writable?" do
    it "should not raise a NotImplementedError error" do
      lambda { @store.writable?(:foo) }.should_not raise_error
    end
  ...
  describe "#read" do
    it "should not raise a NotImplementedError error" do
      lambda { @store.read('foo') }.should_not raise_error
    end
  ...
  describe "#write" do
    it "should not raise a NotImplementedError error" do
      lambda { @store.write('foo', 'bar') }.should_not raise_error
    end
  ...
  describe "#fetch" do
    it "should not raise a NotImplementedError error" do
      lambda { @store.fetch('foo') {'bar'} }.should_not raise_error
    end
  ...
  describe "#exists?" do
    it "should not raise a NotImplementedError error" do
      lambda { @store.exists?('foo') }.should_not raise_error
    end
  ...
  describe "#delete" do
    it "should not raise a NotImplementedError error" do
      lambda { @store.delete('foo') }.should_not raise_error
    end
  ...
  describe "#delete_all!" do
    it "should not raise a NotImplementedError error" do
      lambda {
        begin
          @store.delete_all!
        rescue Merb::Cache::NotSupportedError
        end
